...
import static com.bob.contactsalpha.ContactListDatabaseHelper.TABLE_FAV;
...
public class Favourites extends Fragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        //this query shall be used to open all the names and pick only the names that have a true as the favourite value
        final String selectQuery = "SELECT * FROM " +  DB_CONTACTS_TABLE +" WHERE " + TABLE_FAV + " = 1;";
